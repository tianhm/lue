#!/usr/bin/env python3
"""
Test script to compare old vs new Kokoro TTS word-level timing implementation.
"""
...
async def test_timing_comparison():
    ...
    # Test text with sentences of different lengths
    test_text = "Short. This is a much longer sentence with many more words in it."
